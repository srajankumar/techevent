  ...
  return (
    <div>
      <footer className="text-gray-600 shadow-2xl backdrop-blur-md body-font">
        <div className="w-full md:px-10 py-10 flex md:items-center md:flex-row flex-col">
          ...
          <div className="flex w-full md:px-0 px-10 items-center justify-between">
            ...
            <div className="flex flex-col ml-5">
              <h2 className="title-font text-lg font-poppins font-bold text-gray-900 tracking-widest mb-1">
                Contact
              </h2>
        ...
        <div className="shadow-2xl px-5 bg-indigo-600">
          <div className=" mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-white text-sm text-center sm:text-left">
              © {new Date().getFullYear()} Sahyadri College of Engineering and
              Management | Managed by -
              <Link
                href="https://github.com/srajankumar"
                className="text-white transition duration-300 ml-1 hover:underline underline-offset-4"
